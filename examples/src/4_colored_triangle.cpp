...
int main() {
    ...
    const auto window = ASSERT(Window::create(ctx, "4_colored_triangle", window_size));
    ...
    constexpr auto create_triangle_shader = [] {
        ...
        auto set_alpha_uniform = *ASSERT(sp.bind().make_uniform_setter(glUniform1f, "u_alpha"));
